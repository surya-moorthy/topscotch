  ...
  return (
    <div className="h-full w-screen">
        <div className="flex gap-2 bg-[#FFFF00] w-full justify-center py-1.5">
          ...
          <header className="flex flex-col justify-around w-full">
               <div className="mx-auto flex w-full max-w-[1390px] justify-between px-[10px]">
                    <div className="flex justify-center items-center gap-4">
                         ...
                         <ul className="flex gap-6 p-6">
                              <li className="flex justify-center items-center gap-2 cursor-pointer text-xl font-mono font-medium">
                                Products <ChevronUp size={19}/>
                                </li>
                              <li className="flex justify-center items-center gap-2 cursor-pointer text-xl font-mono font-medium">
                                Customers
                                 <ChevronUp size={19}/>
                                </li>
                                <li className="cursor-pointer text-xl font-mono font-medium">Pricing</li>
                              <li className="flex justify-center items-center gap-1 cursor-pointer text-xl font-mono font-medium">
                                Learn <ChevronUp size={19}/>
                                </li>
                         </ul>
                    </div>
                    <div className="flex justify-center items-center gap-4">
